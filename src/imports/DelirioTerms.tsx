  ...
  return (
    <div className="absolute contents left-[1183px] top-[18px]">
      ...
      <div className="absolute font-['Big_Caslon',serif] h-[20px] leading-[normal] left-[1263.5px] not-italic text-[16px] text-center text-white top-[30px] translate-x-[-50%] w-[121px]">
        <p className="mb-0">Join our waitlist</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Section() {
  return (
    <div className="bg-white h-[5297px] overflow-clip relative shrink-0 w-full" data-name="Section1">
      <Header />
    </div>
  );
}

export default function DelirioTerms() {
  return (
    <div className="bg-[rgba(255,255,255,0)] relative size-full" data-name="delirio/terms">
