export function Logo({color = "black", width = "47", height = "56"}) {
  return (
    <svg width={width} height={height} viewBox="0 0 46.5068 55.2368" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'rotate(45deg)' }}>
      <g clipPath="url(#clip0_19_1608)">
